...
const SuggestionCards = () => {
  return (
    <div className="flex justify-center space-x-4 mb-8">
      <SuggestionCard 
        icon={<Table2 className="text-gray-400" size={24} />}
        text="A tool to upload and edit CSV files"
      />
      <SuggestionCard 
        icon={<Newspaper className="text-gray-300" size={24} />}
        text="A page showing top stories from Hacker News"
      />
      <SuggestionCard 
        icon={<Wrench className="text-gray-200" size={24} />}
        text="Create a boilerplate app I can easily modify"
      />
      <SuggestionCard 
        icon={<Headphones className="text-gray-100" size={24} />}
